...
class _CreateAccountState extends State<CreateAccount> {
  ...
  late String selectedGenderValue; // radio button 으로 선택한 gender 값 : 남성 / 여성
...
// -------------------------------- Widget ---------------------------------- //
// 1. Radio button Widget : select gender
